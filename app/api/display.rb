class Display < Grape::API
	...
	# 			p1 = Post.create!(header: "Service Staff", company: "Fourty Hands", salary: 10.0, description: "Housewives, Students are welcome! SEED-DEMO", location: "448 Ang Mo Kio Ave 10, 560448", posting_date: "2015-08-11", job_date: "2016-01-03", end_date: "2016-01-10", owner_id: u1.id, status: "expired", expiry_date: "2016-01-02", duration: 7, start_time: "11:00", end_time: "18:00", avatar_path: "https://s3-ap-southeast-1.amazonaws.com/media.clockworksmu.herokuapp.com/app/public/assets/logos/14-fortyhands-logo.jpeg", latitude: 1.367516, longitude: 103.856308)
