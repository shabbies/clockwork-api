...
##########################################################################################################################
	    ...
	    get :re_seed, :http_codes => [200, "successful"] do
			...
			u3 = User.create!(email: "kssc91@hotmail.com", password: "password", password_confirmation: "password", account_type: "job_seeker", username: "shabbies", address: "Singapore", contact_number: 97907685, good_rating: 3, neutral_rating: 1, bad_rating: 2, date_of_birth: Date.parse("1991-05-20"), gender: "M", nationality: "Singaporean", latitude: 1.352083, longitude: 103.819836, referral_id: User.generate_referral_id, nric: "S1234567B")
			...
			hoi = User.create!(email: "gerald@gmail.com", password: "password", password_confirmation: "password", account_type: "job_seeker", username: "Gerald Lim", address: "Toa Payoh Central Singapore", contact_number: 91110312, good_rating: 2, neutral_rating: 1, bad_rating: 0, date_of_birth: Date.parse("1980-05-11"), gender: "M", nationality: "Singaporean", avatar_path: "https://s3-ap-southeast-1.amazonaws.com/media.clockworksmu.herokuapp.com/app/public/assets/Gerald.jpg", latitude: 1.3341389, longitude: 103.8491111, referral_id: User.generate_referral_id, nric: "S1234567C")
