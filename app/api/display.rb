...
##########################################################################################################################
	    ...
	    get :re_seed, :http_codes => [200, "successful"] do
      		...
      		u1 = User.create!(email: "scsoh.2012@sis.smu.edu.sg", password: "password", password_confirmation: "password", account_type: "employer", username: "kennethsohsc", address: "Suntec City", contact_number: 98123123, latitude: 1.2959623, longitude: 103.8579517)
			u2 = User.create!(email: "js@smu.edu.sg", password: "password", password_confirmation: "password", account_type: "job_seeker", username: "Joan Shue", address: "Toa Payoh Central Singapore", contact_number: 91110312, good_rating: 1, neutral_rating: 0, bad_rating: 0, date_of_birth: Date.parse("1980-05-11"), gender: "F", nationality: "Singaporean", latitude: 1.3341389, longitude: 103.8491111)
			u3 = User.create!(email: "kssc91@hotmail.com", password: "password", password_confirmation: "password", account_type: "job_seeker", username: "shabbies", address: "Singapore", contact_number: 97907685, good_rating: 3, neutral_rating: 1, bad_rating: 2, date_of_birth: Date.parse("1991-05-20"), gender: "M", nationality: "Singaporean", latitude: 1.352083, longitude: 103.819836)
			...
			hoi = User.create!(email: "gerald@gmail.com", password: "password", password_confirmation: "password", account_type: "job_seeker", username: "Gerald Lim", address: "Toa Payoh Central Singapore", contact_number: 91110312, good_rating: 2, neutral_rating: 1, bad_rating: 0, date_of_birth: Date.parse("1980-05-11"), gender: "M", nationality: "Singaporean", avatar_path: "https://s3-ap-southeast-1.amazonaws.com/media.clockworksmu.herokuapp.com/app/public/assets/Gerald.jpg", latitude: 1.3341389, longitude: 103.8491111)

			today = Date.today

			p1 = Post.create!(header: "Service Staff", company: "Fourty Hands", salary: 10.0, description: "Housewives, Students are welcome! SEED-DEMO", location: "448 Ang Mo Kio Ave 10, 560448", posting_date: "2015-08-11", job_date: "2016-01-03", end_date: "2016-01-10", owner_id: u1.id, status: "applied", expiry_date: "2016-01-02", duration: 7, start_time: "11:00", end_time: "18:00", avatar_path: "https://s3-ap-southeast-1.amazonaws.com/media.clockworksmu.herokuapp.com/app/public/assets/14-fortyhands-logo.jpeg", latitude: 1.367516, longitude: 103.856308)
