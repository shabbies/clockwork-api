...
##########################################################################################################################
	    ...
	    get :re_seed, :http_codes => [200, "successful"] do
			...
			u1 = User.create!(email: "scsoh.2012@sis.smu.edu.sg", password: "password", password_confirmation: "password", account_type: "employer", username: "kennethsohsc (seed)", address: "Suntec City", contact_number: 98123123, latitude: 1.2959623, longitude: 103.8579517, referral_id: User.generate_referral_id, verified: true)
			u2 = User.create!(email: "js@smu.edu.sg", password: "password", password_confirmation: "password", account_type: "job_seeker", username: "Joan Shue (seed)", address: "Toa Payoh Central Singapore", contact_number: 91110312, good_rating: 1, neutral_rating: 0, bad_rating: 0, date_of_birth: Date.parse("1980-05-11"), gender: "F", nationality: "Singaporean", latitude: 1.3341389, longitude: 103.8491111, referral_id: User.generate_referral_id, obtained_badges: ["newbie"], verified: true)
			u3 = User.create!(email: "kssc91@hotmail.com", password: "password", password_confirmation: "password", account_type: "job_seeker", username: "shabbies (seed)", address: "Singapore", contact_number: 97907685, good_rating: 3, neutral_rating: 1, bad_rating: 2, date_of_birth: Date.parse("1991-05-20"), gender: "M", nationality: "Singaporean", latitude: 1.352083, longitude: 103.819836, referral_id: User.generate_referral_id, obtained_badges: ["newbie", "superuser"], verified: true)
			u4 = User.create!(email: "iceicebaby@mail.com", password: "password", password_confirmation: "password", account_type: "employer", username: "IceIceBaby (seed)", contact_number: 98871236, referral_id: User.generate_referral_id, verified: true)
			u5 = User.create!(email: "iscreamstory@mail.com", password: "password", password_confirmation: "password", account_type: "employer", username: "iScreamStory (seed)", contact_number: 81920471, referral_id: User.generate_referral_id, verified: true)
			u6 = User.create!(email: "themeatloversclub@mail.com", password: "password", password_confirmation: "password", account_type: "employer", username: "TheMeatLoversClub (seed)", contact_number: 89018432, referral_id: User.generate_referral_id, verified: true)
			hoi = User.create!(email: "gerald@gmail.com", password: "password", password_confirmation: "password", account_type: "job_seeker", username: "Gerald Lim (seed)", address: "Toa Payoh Central Singapore", contact_number: 81231412, good_rating: 2, neutral_rating: 1, bad_rating: 0, date_of_birth: Date.parse("1980-05-11"), gender: "M", nationality: "Singaporean", avatar_path: "https://s3-ap-southeast-1.amazonaws.com/media.clockworksmu.herokuapp.com/app/public/assets/logos/Gerald.jpg", latitude: 1.3341389, longitude: 103.8491111, referral_id: User.generate_referral_id, obtained_badges: ["newbie"], verified: true)
